...
public class AdmobAdapterWrapper extends BaseAdapter implements AdmobFetcher.AdmobListener {
    ...
    */
    ...
    public AdmobAdapterWrapper(Context context) {
        // TODO hear i am setting values using setter methods defined above
    ...
    private void bindContentAdView(NativeContentAdView adView, NativeContentAd ad) {
        ...
        if(ad.getLogo()!=null){
            System.out.println("_____ HEIGHT : " + ad.getImages().get(0).getDrawable().getIntrinsicHeight() + "_____\n" +
                    "____WIDTH : " + ad.getImages().get(0).getDrawable().getIntrinsicWidth());
        ...
        //TODO hear I am setting big Image
        ImageView ivImage = (ImageView) adView.findViewById(R.id.ivImage);
        if (ad.getImages() != null && ad.getImages().size() > 0) {
            Drawable drawable = ad.getImages().get(0).getDrawable();
            int height = drawable.getIntrinsicHeight();
            int width = drawable.getIntrinsicWidth();
            System.out.println("______________THE DRAWABLE HEIGHT IS : "+height+ " ____\n" +
                    "_______________THE DRAWABLE WIDTH IS : "+width+" ____________");
    ...
    private void bindInstallAdView(NativeAppInstallAdView adView, NativeAppInstallAd ad) {
        ...
        ImageView ivImage = (ImageView) adView.findViewById(R.id.ivImage);
        // TODO set logo image view
        if (ad.getImages() != null && ad.getImages().size() > 0) {
            ivImage.setImageDrawable(ad.getImages().get(0).getDrawable());
            System.out.println("______________THE DRAWABLE HEIGHT IS : "+ad.getImages().get(0).getDrawable().getIntrinsicHeight()+ " ____\n" +
                    "_______________THE DRAWABLE WIDTH IS : "+ad.getImages().get(0).getDrawable().getIntrinsicWidth()+" ____________");
            ivImage.setImageDrawable(ad.getImages().get(0).getDrawable());
