...
import com.protoplus.newscircle.newscircle.MainContent.HTMainContent;
...
public class HindustanTimesNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    int position;
    private final int web_index = 11;
...
/*=====================================================================*/
    ...
    @Override
    public void getNotificationData(Context context, String urlString,int cat_index, String cateogry) {
                ...
                parser.parse(urlString, new DefaultHandler(){
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(HTMainContent.class.getName());
                            ...
                            throws SAXException
                    {
                        if (title  && bean!=null){
                            ...
                            bean.setMainImageLink(image_linkText+"#no");
                        }
...
/*==================================================================*/
    ...
    public HindustanTimesNewsFragment(){
        if(Helper.isAppOpen){
            urlString=Helper.getCurrentURL();
            position=ContextData.getPosition();
            System.out.println("-----------------I am In HTNews Fragment Constructer : POSITION"+position);
            try{
            ...
            System.out.println("-----------------I am in HTNews Fragment constructer : size of Arraylist : "+ar.size());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), HTMainContent.class);
                ContextData.setHT_bean_array(ar);
