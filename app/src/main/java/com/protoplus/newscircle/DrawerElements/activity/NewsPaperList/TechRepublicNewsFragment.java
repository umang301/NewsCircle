...
import com.protoplus.newscircle.newscircle.MainContent.InfoWorldMainContent;
import com.protoplus.newscircle.newscircle.MainContent.TechRepublicMainContent;
 ...
 */
public class TechRepublicNewsFragment  extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    private String category;
    int position;
    private final int web_index = 25;
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(TechRepublicMainContent.class.getName());
...
/*==================================================================*/
    ...
    public TechRepublicNewsFragment(){
        if(Helper.isAppOpen){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), TechRepublicMainContent.class);
                ContextData.setTechRepublic_bean_array(ar);
