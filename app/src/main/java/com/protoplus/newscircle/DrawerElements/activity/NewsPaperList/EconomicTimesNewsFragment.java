...
import com.protoplus.newscircle.newscircle.MainContent.EconomicsTimesMainContent;
...
/**
 * Created by Aakash on 10/5/2015.
 */
public class EconomicTimesNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    private String category;
    int position;

    private final int web_index = 7;
                ...
                parser.parse(urlString, new DefaultHandler(){
                            ...
                            throws SAXException
                    {
                        if (title  && bean!=null){
                            ...
                            if(descriptionText.contains("photo")){
                                bean.setMainImageLink(descriptionText.substring(descriptionText.indexOf("photo")-35,descriptionText.indexOf("photo")+18));
                                bean.setImageLink(descriptionText.substring(descriptionText.indexOf("photo")-35,descriptionText.indexOf("photo")+18));
                            }
                            if(!text1.contains(".cms")){
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(!Helper.fromReceiver){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(EconomicsTimesMainContent.class.getName());
                                    refresh_ar.add(bean);
                                }
                                bean=null;
                            }else{
...
/*==================================================================*/
    ...
    public EconomicTimesNewsFragment(){
        if(!Helper.fromReceiver){
    ...
    @Override
    public void onStart() {
        super.onStart();Helper.isAppOpen = true;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), EconomicsTimesMainContent.class);
                ContextData.setEconomicsTimes_bean_array(ar);
