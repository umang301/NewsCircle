...
import com.protoplus.newscircle.newscircle.MainContent.CNN_IBN_MainContent;
 ...
 */
public class CNN_IBNNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
                ...
                parser.parse(urlString, new DefaultHandler(){
                            ...
                            throws SAXException
                    {
                        if (title  && bean!=null){
                            ...
                            if(text1.contains("http") && text1.contains(".jpg")){
                                bean.setImageLink(text1.substring(text1.indexOf("http"),text1.indexOf(".jpg")+4));
                            }
                            if(text1.contains(">")){
                                text1 = text1.substring(text1.indexOf(">"),text1.length()-1);
                                           ...
                                           String qName) throws SAXException
                    {
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(CNN_IBN_MainContent.class.getName());
                                    refresh_ar.add(bean);
                                }
                                bean=null;
                            }
                        ...
                        else if(qName.equals("guid")&& bean!=null) link = false;
    ...
    private class NewTabData{
        public NewTabData(){
            try {
                ...
                SAXParser parser = SAXParserFactory.newInstance().newSAXParser();
                // TODO put Error Page if Site is not available not Available in LifeStyle and Health
                ...
                /*getActivity().runOnUiThread(new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        dialog.setMessage("This site is currently not available");
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), CNN_IBN_MainContent.class);
                ContextData.setCNN_IBN_bean_array(ar);
