...
import com.protoplus.newscircle.newscircle.MainContent.IndiaTodayMainContent;
 ...
 */
public class IndiaTodayNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    private String category;
    int position;
    private final int web_index = 14;
        ...
        protected void onPostExecute(String s) {
            ...
            if(!Helper.isAppOpen){
                ...
                try{
                    ...
                    if(!Helper.getisBack() && swipeLayout!=null){
                        // TODO Hear null pointer exception occures for swipeLayout
                ...
                parser.parse(urlString, new DefaultHandler(){
                            ...
                            throws SAXException
                    {
                        if (title  && bean!=null){
                            ...
                            if (descriptionText.contains("http") && descriptionText.contains(".jpg") && descriptionText.length() > descriptionText.indexOf(".jpg") + 4 && descriptionText.contains("<") && descriptionText.contains(">")) {
                                String[] sar = descriptionText.split("http");
                                for (String string : sar) {
                                    if (string.contains(".jpg")) {
                                        bean.setImageLink("http" + string.substring(0, string.indexOf(".jpg") + 4));
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(IndiaTodayMainContent.class.getName());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), IndiaTodayMainContent.class);
                ContextData.setIndiaToday_bean_array(ar);
