...
import com.protoplus.newscircle.newscircle.MainContent.LiveMintMainContent;
import com.protoplus.newscircle.newscircle.MainContent.MyDigitalFCMainContent;
 ...
 */
public class mydigtalfcNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;

    int position;
    private String category;
    private final int web_index = 20;
        ...
        public refreshData(){
            try {
                ...
                parser.parse(urlString, new DefaultHandler(){
                    ...
                    boolean title=false,pubDate=false,link=false , description=false,image_link=false,main_image_link=false;
                    String titleText="",postIdText="",image_linkText="",main_image_linkText="";
                    int i=0;
                    int limit=0;
                                             ...
                                             String qName, Attributes attributes) throws SAXException
                    {
                        ...
                        else if(qName.equals("smallimage")&& bean != null){
                            image_link = true;
                            image_linkText = "";
                        }
                        else if(qName.equals("bigimage") && bean!=null){
                            main_image_link=true;
                            main_image_linkText="";
                        }
                            ...
                            throws SAXException
                    {
                        if (title  && bean!=null){
                            ...
                            System.out.println("the thumbnail image is : "+image_linkText);
                            image_linkText = image_linkText+new String(ch,start,length);
                            bean.setImageLink(image_linkText);
                        }
                        else if(main_image_link && bean!=null){
                            main_image_linkText = main_image_linkText + new String(ch,start,length);
                            bean.setMainImageLink(main_image_linkText);
                        }
                        else if(description && bean != null) {
                            String text1 = new String(ch, start, length);
                            System.out.println("description : " + text1);
                                           ...
                                           String qName) throws SAXException
                    {
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(MyDigitalFCMainContent.class.getName());
                        ...
                        else if(qName.equals("smallimage") && bean!=null) image_link=false;

                        else if(qName.equals("bigimage") && bean!=null) main_image_link=false;
                    }
                    @Override
...
/*==================================================================*/
        ...
        public NewTabData(){
            try {
                ...
                parser.parse(urlString,new DefaultHandler(){
                    ...
                    boolean title=false,pubDate=false,link=false , description=false,image_link = false,main_image_link=false;
                    String titleText="",postIdText="",image_link_text="",main_image_link_text="";
                    int i=0;
                    int limit=0;
                    public void startElement(String uri, String localName,
                                             String qName, Attributes attributes) throws SAXException
                    {
                        if (limit<Minimum_Value){
                            ...
                            else if(qName.equals("smallimage")){
                                image_link=true;
                                image_link_text = "";
                            }
                            else if(qName.equals("bigimage")){
                                main_image_link=true;
                                main_image_link_text="";
                            }
                            ...
                            throws SAXException
                    {
                        if (title  && bean!=null){
                            ...
                            System.out.println("the thumbnail image is : "+image_link_text);
                            image_link_text = image_link_text +new String(ch, start,length);
                            bean.setImageLink(image_link_text);
                        }
                        else if(main_image_link && bean!=null){
                            main_image_link_text = main_image_link_text + new String(ch, start, length);
                            bean.setMainImageLink(main_image_link_text);
                        }
                    }
                    @Override
                    public void endDocument() throws SAXException {
    ...
    private class ListIEHandler extends DefaultHandler {
        public boolean title=false,pubDate=false,link=false , description=false,image_link=false,main_image_link=false;
        public String descriptionText = "" , image_link_text="",main_image_link_text="";
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            ...
            if(limit< Minimum_Value){
                ...
                if(qName.equals("item")){
                    System.out.println("__new Item is started");
                    bean = new SportChildSceneBean();
                }
                else if (qName.equals("title") ){
                    titleText="";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), MyDigitalFCMainContent.class);
                ContextData.setMyDigitalFC_bean_array(ar);
