...
import com.protoplus.newscircle.newscircle.MainContent.WiredMainContent;
 ...
 */
public class WiredNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    private String category;
    int position;
    private final int web_index = 28;
                ...
                parser.parse(urlString, new DefaultHandler(){
                                             ...
                                             String qName, Attributes attributes) throws SAXException
                    {
                        if (qName.equals("item")){
                            ...
                            bean.setImageLink(attributes.getValue("src"));
                        }
                            ...
                            throws SAXException
                    {
                        if (title  && bean!=null){
                            ...
                            {
                                try{
                                    String ImageLink = descriptionText.substring(descriptionText.indexOf("<img src=")+10,descriptionText.indexOf(".jpg")+4);
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(WiredMainContent.class.getName());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), WiredMainContent.class);
                ContextData.setWired_bean_array(ar);
