...
import com.protoplus.newscircle.newscircle.MainContent.TheStatesManMainContent;
 ...
 */
public class TheStatesmanNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    private String category;
    int position;
    private final int web_index = 26;
            ...
            try {
                ...
                parser.parse(urlString, new DefaultHandler(){
                                             ...
                                             String qName, Attributes attributes) throws SAXException
                    {
                        ...
                        else if(qName.equals("thumbimg")&& bean != null){
                            image_link = true;
                            image_linkText = "";
                        }
                        else if(qName.equals("largeimg") && bean!=null){
                                           ...
                                           String qName) throws SAXException
                    {
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(TheStatesManMainContent.class.getName());
                        ...
                        else if(qName.equals("content") && bean!=null) description = false;

                        else if(qName.equals("thumbimg") && bean!=null) image_link=false;

                        else if(qName.equals("largeimg") && bean!=null) main_image_link=false;
                    }
                    @Override
...
/*==================================================================*/
    ...
    public TheStatesmanNewsFragment(){
        if(Helper.isAppOpen){
                ...
                parser.parse(urlString,new DefaultHandler(){
                                             ...
                                             String qName, Attributes attributes) throws SAXException
                    {
                        if (limit<Minimum_Value){
                            ...
                            else if(qName.equals("thumbimg")){
                                image_link=true;
                                image_link_text = "";
                            }
                            else if(qName.equals("largeimg")){
                                main_image_link=true;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), TheStatesManMainContent.class);
                ContextData.setTheStatesMan_bean_array(ar);
