...
import com.protoplus.newscircle.newscircle.MainContent.OneIndiaMainContent;
...
public class OneIndiaNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {

    int counter=0;
    private String category;
    int Minimum_Value=0;
    int position;
    private final int web_index = 21;
                ...
                parser.parse(urlString, new DefaultHandler(){
                                             ...
                                             String qName, Attributes attributes) throws SAXException
                    {
                        ...
                        if (qName.equals("item")){
                            ...
                            bean.setMainImageLink(attributes.getValue("url")+"#no");
                        }
                    }
                                           ...
                                           String qName) throws SAXException
                    {
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(OneIndiaMainContent.class.getName());
                                    refresh_ar.add(bean);
                                }
                                bean=null;
                            }else{
                        ...
                        else if(qName.equals("enclosure") && bean!=null) image_link=false;
    ...
    private class NewTab extends AsyncTask<String,String,String>{
        ...
        protected void onPostExecute(String s) {
            ...
            if(cantConnect){
                ...
                errorText.setText("The Content is currently not available");
    ...
    private class NewTabData{
        public NewTabData(){
            try {
                                           ...
                                           String qName) throws SAXException
                    {
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            ...
                            if(counter>6){
                                ...
                                System.out.println("----------------Swipe ni pachino data : position : " + position + " the size of arraylist is : " + ar.size());
                                ContextData.getMain_ar().set(position, ar);
                                throw new SAXException();
                            }
                            bean.setMainContentClass(OneIndiaMainContent.class.getName());
                ...
                // TODO hear i have to put massage webpage not available
                e.printStackTrace();
                cantConnect = true;
            }
        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), OneIndiaMainContent.class);
                ContextData.setOneIndia_bean_array(ar);
