...
import com.protoplus.newscircle.newscircle.MainContent.AsiaAgeMainContent;
 ...
 */
public class AsiaAgeNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, IGetNotification {
    int counter = 0;
    static int Minimum_Value = 0;
    ...
    LoadData loadData;
    myTask refreshTask;
    String descriptionText = "", descriptionText1 = "";
    ...
    public void getNotificationData(Context context, String urlString,int cat_index, String category) {
        System.out.println("(:) (::) (:::) (::) (:)In AsiaAge I AM CHECKING WHETHER ANY UPDATION IS THERE OR NOT___________________");
        Minimum_Value = 0;
        ...
        protected void onPostExecute(String s) {
            if (!Helper.isAppOpen) {
                if (refresh_ar.size() > 0) {
                    System.out.println("() I am in onPostExecute of Asia Age(:) (::) (:::) (::) (:)");
                    System.out.println(">>>>>>>>>>Line no 146 : THe SharedPreferences is :" + mPrefs);
                    ...
                    // for(SportChildSceneBean bean:refresh_ar) {
                    System.out.println(".....>the iterator is started...");
        ...
        public refreshData() {
            try {
                ...
                parser.parse(urlString, new DefaultHandler() {
                    ...
                    boolean title = false, pubDate = false, link = false, description = false;
                    ...
                    public void characters(char ch[], int start, int length)
                        ...
                        if (title && bean != null) {
                            ...
                            if (descriptionText.contains("http") && descriptionText.contains(".jpg")) {
                                bean.setMainImageLink(descriptionText.substring(descriptionText.indexOf("http:"), descriptionText.indexOf(".jpg") + 4));
                            }
                            if (descriptionText.contains("<div>") && descriptionText.contains("</div>")) {
                                descriptionText.replace(descriptionText.substring(descriptionText.indexOf("<div>"), descriptionText.indexOf("</div>")), "");
                        ...
                        if (qName.equals("item") && bean != null) {
                            if (Helper.isAppOpen) {
                                if (bean.getTitle().equals(ar.get(0).getTitle())) {
                                    ...
                                    bean.setMainContentClass(AsiaAgeMainContent.class.getName());
...
/*==================================================================*/
    ...
    public AsiaAgeNewsFragment() {
        System.out.println("...................._________" +
                "\nThe Helper.isAppOpen Variable is _____________............." +
                "\n:  " + Helper.isAppOpen + "\n.....>>>>>>>>>>>>>>>>>>>>>>>");
        if (Helper.isAppOpen) {
            urlString = Helper.getCurrentURL();
    ...
    private class NewTab extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if (centerLoader != null) {
                try {
                    System.out.println(".......>  THe title is :: " + ar.get(0).getTitle() + "......// > The Image Link is : " + ar.get(0).getImageLink());
                    Helper.WriteHeadLineData(mPrefs, web_index,cat_index, ar.get(0).getImageLink() + "&&&&" + ar.get(0).getTitle());

                } catch (Exception e) {
                    System.out.println("..... > The first value of arraylist is : null");
                    e.printStackTrace();
                }
    ...
    private class NewTabData {
        public NewTabData() {
            try {
                ...
                SAXParser parser = SAXParserFactory.newInstance().newSAXParser();
                System.out.println("Asia Age URL is  : .......... : "+urlString+" : ......... :");
                parser.parse(urlString, new DefaultHandler() {
    ...
    private class ListIEHandler extends DefaultHandler {
        public boolean title = false, pubDate = false, link = false, description = false;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), AsiaAgeMainContent.class);
                ContextData.setAsiaAge_bean_array(ar);
