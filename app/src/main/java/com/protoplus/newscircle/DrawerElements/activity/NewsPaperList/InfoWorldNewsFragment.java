 ...
 */
public class InfoWorldNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    private String category;
    int position;
    private final int web_index = 16;
            ...
            try {
                ...
                parser.parse(urlString, new DefaultHandler(){
                                             ...
                                             String qName, Attributes attributes) throws SAXException
                    {
                        ...
                        else if(qName.equals("media:content") && bean!=null){
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(InfoWorldMainContent.class.getName());
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), InfoWorldMainContent.class);
                ContextData.setInfoWorldNewsFragment_bean_array(ar);
