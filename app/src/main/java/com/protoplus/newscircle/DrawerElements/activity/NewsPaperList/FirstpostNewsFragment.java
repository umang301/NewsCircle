...
import com.protoplus.newscircle.newscircle.MainContent.FirstpostMainContent;
 ...
 */
public class FirstpostNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    int page_no = 1;

    private final int web_index = 8;
    int cat_index;
...
//private String category;
    ...
    public void getNotificationData(Context context, String urlString,int cat_index,String category) {
        ...
        System.out.println("_________________The Category is : "+category);
    ...
    private class myTask extends AsyncTask<String,String,String> {
        ...
        public myTask(Context context) {
            if (context != null) {
                ...
                System.out.println("...................>>>>>>>>>>>>> The Current URL is  : " + "http://www.firstpost.com/category/"+category+"/page/0");
    ...
    private class refreshData{
        public refreshData(){
            try {
                System.out.println("*********** The URL is : "+"http://www.firstpost.com/category/"+category+"/page/0");
                SAXParserImpl.newInstance(null).parse(new URL("http://www.firstpost.com/category/"+category+"/page/0").openConnection().getInputStream(), new NewTabHandler() {
                    ...
                    public void startElement(String uri, String localName,
                        ...
                        } else if(name.equals("li") && start_list){
                    ...
                    public void endElement(String uri, String localName,
                        ...
                        else if (qName.equals("li")  && bean != null) {
                            if(!Helper.fromReceiver){
                                if (bean.getTitle().equals(ar.get(0).getTitle())) {
                                    ContextData.getMain_ar().set(position, ar);
                                    throw new SAXException();
                                } else if (bean != null) {
                                    bean.setMainContentClass(FirstpostMainContent.class.getName());
                        ...
                        }  else if (qName.equals("span") && bean != null) {
                            pubDate = false;
                        }
                    }
...
/*==================================================================*/
    ...
    public FirstpostNewsFragment() {
        category = Helper.getCategory();
        System.out.println("In Firstpost news fragment the category is : "+category);
    ...
    private class NewTabHandler extends DefaultHandler{
        public boolean title=false,pubDate=false,link=false , description=false, imageLink = false ,start_list = false;
        public void startElement(String uri, String localName,
                                 String name, Attributes a)
        {
            if (name.equalsIgnoreCase("ul")) {
    ...
    private class NewTabData{
        public NewTabData(){
            try{
                System.out.println("Page No is :" + page_no + "URL is :::: http://www.firstpost.com/category/"+category+"/page/"+page_no);
                SAXParserImpl.newInstance(null).parse(new URL("http://www.firstpost.com/category/"+category+"/page/"+page_no).openConnection().getInputStream(),
                        new NewTabHandler());
            }catch(SAXException e){
                e.printStackTrace();
    ...
    private class getList{
        public getList(){
            try {
                ...
                counter = 0;page_no +=1;
                SAXParserImpl.newInstance(null).parse(new URL("http://www.firstpost.com/category/"+category+"/page/"+page_no).openConnection().getInputStream(), new NewTabHandler());
            } catch (SAXException e) {
                e.printStackTrace();
            } catch (IOException e) {
                e.printStackTrace();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), FirstpostMainContent.class);
                ContextData.setFirstPost_bean_array(ar);
