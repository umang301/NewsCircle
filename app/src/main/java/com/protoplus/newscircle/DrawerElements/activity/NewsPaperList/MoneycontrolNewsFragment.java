...
import com.protoplus.newscircle.newscircle.MainContent.MoneyControlMainContent;
 ...
 */
public class MoneycontrolNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    private String category;
    int position;

    private final int web_index = 18;
                            ...
                            throws SAXException
                    {
                        if (title  && bean!=null){
                            ...
                            if(descriptionText.contains("http") && descriptionText.contains(".jpg")){
                                bean.setImageLink(descriptionText.substring(descriptionText.indexOf("http"),descriptionText.indexOf(".jpg")+4));
                            }
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(MoneyControlMainContent.class.getName());
...
/*==================================================================*/
    ...
    public MoneycontrolNewsFragment(){
        if(Helper.isAppOpen){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), MoneyControlMainContent.class);
                ContextData.setMoneyControl_bean_array(ar);
