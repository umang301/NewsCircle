...
import com.protoplus.newscircle.newscircle.MainContent.RediffMainContent;
 ...
 */
public class RediffNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    private String category;
    String imgURL;
    int position;
    private final int web_index = 23;
            ...
            try {
                ...
                parser.parse(urlString, new DefaultHandler(){
                                             ...
                                             String qName, Attributes attributes) throws SAXException
                    {
                        ...
                        else if(qName.equals("image")&& bean != null){
                            image_link = true;
                            image_linkText = "";
                        }
                            ...
                            throws SAXException
                    {
                        ...
                        /*else if (pubDate  && bean!=null) {
                            ...
                            imgURL = new String(ch,start,length);
                            bean.setImageLink(imgURL);
                            bean.setMainImageLink(imgURL);
                            /*imgURL = new String(ch,start,length);
                            image_linkText = image_linkText+imgURL;
                            bean.setImageLink(image_linkText);
                            main_image_linkText = main_image_linkText + imgURL;
                                           ...
                                           String qName) throws SAXException
                    {
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(RediffMainContent.class.getName());
                        ...
                        else if(qName.equals("image") && bean!=null) image_link=false;
        ...
        public NewTabData(){
            try {
                ...
                parser.parse(urlString,new DefaultHandler(){
                    ...
                    boolean title=false,link=false , description=false,image_link = false,main_image_link=false;
                                             ...
                                             String qName, Attributes attributes) throws SAXException
                    {
                        if (limit<Minimum_Value){
                            ...
                            if(qName.equals("item")){
                                ...
                                postIdText = "";
                                System.out.println("inside link portion in rediff");
                                link = true;
                            }
                            ...
                            throws SAXException
                    {
                        ...
                        /*else if (pubDate  && bean!=null) {
                            ...
                            postIdText=postIdText+new String(ch, start, length);
                            System.out.println(":::::::In reddif news Fragment : The post id is : "+postIdText);

                            bean.setPostId(postIdText);
                        }
                        if(description && bean != null){
                            String text1 = new String(ch, start, length);
                            bean.setDescription(text1);
                        }
                        if(image_link && bean!=null){
                            imgURL = new String(ch,start,length);
                            bean.setImageLink(imgURL);
                            bean.setMainImageLink(imgURL);
                        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), RediffMainContent.class);
                ContextData.setRediff_bean_array(ar);
