...
import com.protoplus.newscircle.newscircle.MainContent.HinduBusinessLineMainContent;
 ...
 */
public class HinduBusinessLineNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener,IGetNotification {
    int counter=0;
    int Minimum_Value=0;
    int position;
private String category;
    private final int web_index = 10;
                        ...
                        if (qName.equals("item") && bean!=null)
                        {
                            if(Helper.isAppOpen){
                                if(bean.getTitle().equals(ar.get(0).getTitle())){
                                    ...
                                    bean.setMainContentClass(HinduBusinessLineMainContent.class.getName());
...
/*==================================================================*/
    ...
    public HinduBusinessLineNewsFragment(){
        if(Helper.isAppOpen){
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), HinduBusinessLineMainContent.class);
                ContextData.setHinduBusinessLine_bean_array(ar);
