 ...
 */
public class TimesOfIndiaNewsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener, IGetNotification {

    int counter = 0;
    int Minimum_Value = 0;
    int position;
    private String category;
    private final int web_index = 27;
    boolean end = false;
                ...
                parser.parse(urlString, new DefaultHandler() {
                        ...
                        if (qName.equals("item") && bean != null) {
                            ...
                            if(Helper.isAppOpen){
                                if (bean.getTitle().equals(ar.get(0).getTitle())) {
                                    ...
                                    bean.setMainContentClass(TimesOfIndiaMainContent.class.getName());
                    ...
                    public void characters(char ch[], int start, int length)
                        ...
                        if (title && bean != null) {
                            ...
                            if (text1.contains("margin-right")) {
                                try {
                                    bean.setImageLink(text1.substring(text1.indexOf("margin-right") + 24, text1.indexOf("margin-right") + 24 + 53));
                                    bean.setMainImageLink(bean.getImageLink() + "#no");
    ...
    private class NewTabData {
        public NewTabData() {
            try {
                ...
                SAXParser parser = SAXParserFactory.newInstance().newSAXParser();
                // TODO set Error Page if site is not available
                parser.parse(urlString, new DefaultHandler() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                                    long arg3) {
                Intent it = new Intent(getActivity().getApplicationContext(), TimesOfIndiaMainContent.class);
                ContextData.setTimesOfIndia_bean_array(ar);
